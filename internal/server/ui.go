...
<header>
  ...
  <span style="color:var(--cream);font-weight:600;">Relay</span>
  <span class="badge">v0.1.0</span>
</header>
<main>
  <div class="hero">
    <h1>Relay</h1>
    <p>Webhook sender — define events, external services register callbacks, fire and deliver with retry</p>
  </div>
  <div class="stats">
    <div class="stat">
  ...
  <div class="card">
    ...
    <div class="tier-box">
      <div class="tier">
        ...
        <div class="tier-desc">5 events, 10 subscriptions</div>
        <div class="tier-price">$0/mo</div>
      </div>
      <div class="tier pro">
        <div class="tier-name">Pro</div>
        <div class="tier-desc">Unlimited events and subscriptions</div>
